data.countries = [
  {
    ...
    coops: [
      ...
      },
      {
        ...
        logo: "elmaizal.jpg",
        tagline: "elmaizal-tagline",
        description: "elmaizal-description",
        services: [
          "Campaigns",
    ...
    coops: [
      {
        ...
        tagline: "webarchitects-tagline",
        description: "webarchitects-description",
        services: [
          "Server Installation and Configuration",
          "System Administration",
          "Hosting",
  ...
  coops: [
    {
      name: "Coodi",
      url: "https://coodi.com.uy/",
      logo: "coodi.png",
      tagline: "coodi-tagline",
      description: "coodi-description",
      services: [
        "Websites",
        "Software Development",
